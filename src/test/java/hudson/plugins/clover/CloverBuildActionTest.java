...
class CloverBuildActionTest {
    ...
    void testExpireAfterAccessFreeStyleProject() throws Exception {
        ...
        CloverPublisher cloverPublisher = new CloverPublisher(
                getClass().getResource("/hudson/plugins/clover/").getPath(), "clover.xml");
        ...
        pipeline.setDefinition(new CpsFlowDefinition(
                ...
                node {
                    step([
                        ...
                        healthyTarget: [methodCoverage: 10, conditionalCoverage: 50, statementCoverage: 10],
                        unhealthyTarget: [methodCoverage: 5, conditionalCoverage: 25, statementCoverage: 5],
    ...
    void testEqualsMethod() {
        CloverBuildAction action1 =
                CloverBuildAction.load(WORKSPACE_PATH_1, null, "1", HEALTHY_TARGET_1, UNHEALTHY_TARGET_1);
        CloverBuildAction action2 =
                CloverBuildAction.load(WORKSPACE_PATH_1, null, "1", HEALTHY_TARGET_1, UNHEALTHY_TARGET_1);
        CloverBuildAction actionDiffReportId =
                CloverBuildAction.load(WORKSPACE_PATH_1, null, "2", HEALTHY_TARGET_1, UNHEALTHY_TARGET_1);
        CloverBuildAction actionDiffWorkspace =
                CloverBuildAction.load(WORKSPACE_PATH_2, null, "1", HEALTHY_TARGET_1, UNHEALTHY_TARGET_1);
        CloverBuildAction actionDiffTargets =
                CloverBuildAction.load(WORKSPACE_PATH_1, null, "1", HEALTHY_TARGET_2, UNHEALTHY_TARGET_2);
